...
@section('content')
    <h3 class="page-title">
        Thông tin quyết định hưởng<small> đối tượng trợ cấp thường xuyên</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'hosoxinhuongtx/'. $model->id, 'class'=>'horizontal-form']) !!}
            ...
            <div style="text-align: center">
                <a href="{{url('hosoxinhuongtx')}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
