...
@section('content')
<h3 class="page-title">
    {{$loaitrocap->tenloai}}<small> thêm mới</small>
</h3>
<div class="row">
    {!! Form::open(['url'=>'danhsachdoituongtx','method'=>'post' , 'files'=>true, 'id' => 'create_doituong','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
