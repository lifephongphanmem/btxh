...
@section('content')
<h3 class="page-title">
    {{$loaitrocap->tenloai}} <small> chỉnh sửa hồ sơ xin hưởng</small>
</h3>
<div class="row">
    {!! Form::model($model, ['method' => 'PATCH','enctype'=>'multipart/form-data','url'=>'danhsachdoituongxinhuongtctx/'. $model->id, 'class'=>'horizontal-form']) !!}
