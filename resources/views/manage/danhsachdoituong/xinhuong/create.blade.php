...
@section('content')
<h3 class="page-title">
    {{$loaitrocap->tenloai}}<small> xin hưởng</small>
</h3>
<div class="row">
    {!! Form::open(['url'=>'danhsachdoituongxinhuongtctx','method'=>'post' , 'files'=>true, 'id' => 'create_doituong','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
    <input type="hidden" name="pltrocap" id="pltrocap" value="{{$trocap}}">
            ...
            <div class="portlet-body form" id="form_wizard">
                <div class="form-body">
                    ...
                    <div class="tab-content">
                        @include('manage.danhsachdoituong.xinhuong.include.tthoso')
                        @include('manage.danhsachdoituong.xinhuong.include.tttrocap')
                        @include('manage.danhsachdoituong.xinhuong.include.ttdinhkem')
                    </div>
                    <hr>
                    <div class="row">
